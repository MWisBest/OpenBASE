...
public enum KeyboardKey
{
	...
	{
		if( lookupKeyCode.containsKey( key ) ) return lookupKeyCode.get( key );
		else if( lookupKeyCode.containsKey( 256 + key ) ) return lookupKeyCode.get( 256 + key );
		return KEY_UNKNOWN;
	}
	
	static
	{
		for( KeyboardKey key : values() ) lookupKeyCode.put( key.keyCode, key );
	}
}