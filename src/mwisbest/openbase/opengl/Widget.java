...
public class Widget
{
	...
	protected WidgetType type = WidgetType.DEFAULT;
	...
	public Widget( Font font, String text )
	{
	...
	public void render()
	{
		if( this.type == WidgetType.TEXTURE || this.type == WidgetType.BUTTON )
		{
		...
		else if( this.type == WidgetType.LABEL )
		{
